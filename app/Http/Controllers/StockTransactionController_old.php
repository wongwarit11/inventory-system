...
class StockTransactionController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $query = StockTransaction::with(['product.category', 'batch', 'user', 'department']);

        // 🔍 กรองตาม category_id ถ้ามีการเลือก
        ...
        // 📦 ดึงรายการหมวดหมู่ทั้งหมดเพื่อใช้ใน dropdown
        $categories = \App\Models\Category::orderBy('name')->get();

        return view('stock_transactions.index', compact('transactions', 'categories'));
    }
