...
@section('content')
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1><i class="fas fa-sitemap me-2 text-primary"></i>{{ config('app.name') }}: 
            <span class="text-secondary">จัดการประเภทสินค้า</span>
        </h1>
    ...
    <div class="row mb-3">
    <div class="col-md-6">
        <form action="{{ route('product-types.index') }}" method="GET">
            <div class="input-group">
                <input type="text" name="search" class="form-control" placeholder="ประเภทสินค้า..." value="{{ request('search') }}">
