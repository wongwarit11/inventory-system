...
@section('content')
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1><i class="fas fa-sitemap me-2 text-primary"></i>{{ config('app.name') }}: 
            <span class="text-secondary">จัดการสินค้า</span>
        </h1>
    ...
    <div class="col-md-6">
        <form action="{{ route('products.index') }}" method="GET">
            <div class="input-group">
                <input type="text" name="search" class="form-control" placeholder="ค้นหาชื่อสินค้า/หมวดหมู่สินค้า/ประเภทสินค้า/ผู้จำหน่าย..." value="{{ request('search') }}">
